...
final class UserViewController: UIViewController {
    ...
    // MARK: - Init
    init(userId: String, navigation: StatisticsUserPageNavigation?) {
        super.init(nibName: nil, bundle: nil)
        configureViewModel(with: userId, navigation: navigation)
    }
    ...
    // MARK: - Setup UI
    private func configureViewModel(with userId: String, navigation: StatisticsUserPageNavigation?) {
        let viewModel = UserViewModel(networkClient: DefaultNetworkClient(), userId: userId, navigation: navigation)
